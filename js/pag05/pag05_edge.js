        ...
        symbols = {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['420px', '241px', '530px', '230px', 'auto', 'auto'],
                            cursor: 'pointer',
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['690px', '389px', '170px', '22px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['24px', '269px', '401px', '280px', 'auto', 'auto'],
                            cursor: 'pointer',
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['35px', '555px', '378px', '24px', 'auto', 'auto'],
            ...
            "texto01": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['0px', '0px', '902px', '226px', 'auto', 'auto'],
                            textStyle: ['', '', '27px', ''],
