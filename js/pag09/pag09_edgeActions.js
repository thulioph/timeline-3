...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 5390, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 8845, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 13220, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 17800, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindElementAction(compId, symbolName, "${imagem09_04_01}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_1}", "click", function(sym, e) {
         ...
         parent.APP.FancyBox.openText ("txt09_03_01");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_2}", "click", function(sym, e) {
         ...
         parent.APP.FancyBox.openText ("txt09_03_02");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_3}", "click", function(sym, e) {
         ...
         parent.APP.FancyBox.openText ("txt09_04_03");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_4}", "click", function(sym, e) {
         ...
         parent.APP.FancyBox.openText ("txt09_05_04");
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-6208098");